...
const Jodi = () => {
    ...
    const handleSubmit = () => {
        ...
        amounts.forEach((row, rowIndex) => {
            row.forEach((amount, index) => {
                if (amount) {
                    bids.push({ digit: `${rowIndex}${index}`, points: parseInt(amount), type: gameType });
                }
            });
        });
        setReviewData({
    ...
    const confirmSubmit = async () => {
        ...
        const payload = {
            ...
            userbalance: balance - reviewData.totalAmount,
        ...
        try {
            ...
            if (response.data.success) {
                setBalance(balance => balance - reviewData.totalAmount);
