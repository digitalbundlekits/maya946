...
const DoublePanaBulk = () => {
    ...
    const marketId = state?.marketId || 1; // Default to 1 if marketId is not specified in state
    ...
    const getMarketAndGameType = () => {
        ...
        return { table: 'bids', marketIdField: 'market', gameTypeId: 14 }; // Default for other markets
    };
