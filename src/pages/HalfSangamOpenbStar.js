...
const HalfSangam = () => {
  ...
  // Get parameters from URL and state
  const { marketName } = useParams();
  const { state } = useLocation();
  // Dynamically source marketId from state or default to 1
  ...
  const panaNumbers = {
    ...
    1: ["777", "128", "137", "146", "236", "245", "290", "380", "470", "489", "560", "579", "678", "100", "119", "155", "227", "335", "344", "399", "588", "669"],
    2: ["444", "138", "129", "147", "156", "237", "246", "345", "390", "480", "570", "679", "589", "110", "200", "228", "255", "336", "499", "660", "688", "778"],
    3: ["111", "139", "120", "148", "157", "238", "247", "256", "346", "490", "580", "689", "670", "166", "229", "300", "337", "355", "455", "599", "779", "788"],
    4: ["888", "149", "130", "158", "167", "239", "248", "257", "347", "356", "590", "789", "680", "112", "220", "266", "338", "400", "446", "455", "699", "770"],
    5: ["555", "159", "140", "168", "230", "249", "258", "267", "348", "357", "456", "780", "690", "113", "122", "177", "339", "366", "447", "500", "799", "889"],
    6: ["222", "150", "123", "169", "178", "240", "259", "268", "349", "358", "367", "790", "457", "600", "114", "277", "330", "448", "466", "556", "880", "899"],
    7: ["999", "160", "124", "179", "250", "269", "278", "340", "359", "368", "458", "890", "467", "115", "133", "188", "223", "377", "449", "557", "566", "700"],
    8: ["666", "134", "125", "170", "189", "260", "279", "350", "369", "378", "459", "567", "468", "116", "224", "233", "288", "440", "477", "558", "800", "990"],
    9: ["333", "135", "126", "180", "234", "270", "289", "360", "379", "450", "469", "568", "478", "117", "144", "199", "225", "388", "559", "577", "667", "900"]
  };

  /**
   * Determines the appropriate table and fields based on the market name.
   */
  const getMarketAndGameType = () => {
    if (marketName === "Mira Starline") {
      return { table: "sbids", marketIdField: "starline", gameTypeId: 20, marketId };
    }
    if (marketName === "Mira Jackpot") {
      return { table: "jbids", marketIdField: "jackpot", gameTypeId: 20, marketId };
    }
    return { table: "bids", marketIdField: "market", gameTypeId: 20, marketId };
  };
  ...
  const handleOpenPanaChange = (value) => {
    ...
    setTimeout(() => {
      // Focus the dropdown after setting the new series
  ...
  return (
    ...
    <img src="/assets/back-arrow.png" alt="Back" />
        ...
        <h2>{marketName ? marketName.toUpperCase() : "UNKNOWN"}, HALF SANGAM B</h2>
