...
const JodiBulk = () => {
    ...
    const getMarketAndGameType = () => {
        ...
        return { table: 'bids', marketIdField: 'market', gameTypeId: 17 }; // Default for other markets
    };
    ...
    const handleJodiSelect = (jodi) => {
        const newBet = { digit: jodi, points: pointValue, type: 'close' };
        setBets([...bets, newBet]);
        setDigitInput('');
        setJodiOptions([]);
    };
                    ...
                    <div className="dropdown">
                        {jodiOptions.map((option) => (
                            <div
                                ...
                                onClick={() => handleJodiSelect(option.toString().padStart(2, '0'))}
                            >
